            ...
            <div className="flex p-6 mb-4 text-yellow-800 bg-yellow-50 rounded-lg">
                  ...
                  <span className="sr-only">
                    ...
                    <div className="m;-3 text-sm font-medium">
                      To get approval please complete your profile and review manually and approve within 3 working  days
                    </div>
              ...
              <div className="mt-8">
                ...
                <div> 
                  <div className="flex items-center gap-4 mb-10">
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-[6px]">
                        ...
                        <span className=" text-textColor text-[14px] leading-5 lg:text-[16px] font-semibold ">
                          ({data.totalRating})
                        </span>
                      </div>
                  ...
                  <Doctorsabout name={data.name}  // Doctors about section is not completed 
                   about={data.about}
