...
import videosIcon from "../assets/images/video-icon.png"
        ...
        <div>
          <div className='lg:w-[570px]'>
            ...
            <p className='text__para'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit illo vero, iure mollitia ipsa obcaecati debitis unde consequatur illum quaerat suscipit omnis vitae repudiandae officia inventore veniam accusantium dolore? Labore!
            </p>
    ...
    <section>
      <div className='container'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]'> 
          ...
          <h2 className='text-[26px] leading-9 text-textColor font-[400] text-center'>Find a Doctor</h2>
          ...
          <div className='xl:w-[670px]'>
            ...
            <ul className='pl-4'>
              <li className='text__para'>
                1. Schedule the appointments directly.
              </li>
              <li className='text__para'>2. Search for your physician here, and contact their office</li>
              <li className='text__para'>3. View our physicians who are accepting new patients, wse the online scheduling tool to select an appointment time.</li>
            </ul>
              ...
              <div className='w-[150px] lg:w-[248px] bg-white absolute bottom-[50px] left-0 md:bottom-[100px] md:left-5 z-20 p-2 pb-3 lg:pt-4 lg:px-4 lg:pb-[26px] rounded-[10px]'>
                <div className='flex items-center justify-between'>
                  ...
                  <div className='bg-white'>
                    <span className='w-5 h-5 lg:w-[34px]  lg:h-[34px] flex items-center justify-center bg-yellowColor rounded  py-[py-1] px-[6px] lg:py-3 lg:px-[9px] '><img src={videosIcon} alt="" />
                    </span>
                  </div>
                </div>
        ...
        <div className='container'>
            <div className='flex justify-between gap-[50px] lg:gap-0'>
              ...
              <div className='w-full md:w-1/2'>
                <h2 className='heading text-headingColor'>Most questions by our beloved patients
                </h2>
                <FaqList/>
              </div>
            </div>
