        ...
        <div className='grid md:grid-cols-3 gap-[50px]'>
          <div className='md:col-span-2'>
            <div className='flex items-center justify-center gap-5'>
              ...
              <div>
                <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-6 lg-py-2 lg-px-6 text-[12px] leading-4 lg:text-[16px] lg:leading7 font-semibold rounded'>{specialization}</span>
                ...
                <div className='flex item gap-[6px]'>
                  ...
                  <span className='text-[14px] leading-5 lg:text-[6px] lg:leading-7 font-[400]'>({totalRating})</span>
                </div>
                <p className='text__para text-sm text-start w-[400px]'>{bio} </p>
              </div>
            </div>
            ...
            <div>
              ...
              {tab === "feedback" && <Doctorsfeedback reviews={reviews}
