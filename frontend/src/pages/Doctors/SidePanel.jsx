  ...
  return (
    <div className='shadow-panelShadow p-3 lg:p-5 rounded-md'>
            ...
            <div className='flex text-center justify-between '>
              ...
              <span className='text-[16px] leading-7 lg:text-[22px] lg:leading-8 text-headingColor'>{ticketPrice} Rupees</span>
            </div>
        ...
        className='btn rounded-md px-2 w-full'>Book Appointment</button>
