    ...
    <div>
      ...
      <form >
        ...
        <div className="mb-5">
            ...
            <input type="email" name="email" value={formData.email} onChange={handleInputChange} placeholder="Email" className="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500" readOnly 
            aria-readonly
            />
        </div>
        ...
        <div className="mb-5">
          <div className="grid grid-cols-3 gap-5 mb-[30px]">
            <div>
              ...
              <select name="gender" value={formData.gender} onChange={handleInputChange}  className="form__input" >
        ...
        <div className="mb-5">
                ...
                className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add experiences</button>
            </div>
        <div className="mb-5">
                  ...
                  <div key={index} >
                    ...
                    <div className="grid grid-cols-2 gap-5 md:grid-cols-4 mb-[30px]">
                        <div>
                          ...
                          <select name="day" value={item.day} className="form__input "
                ...
                className="bg-[#000] py-2 px-5 rounded text-white h-fit cursor-pointer">Add Time Slots</button>
            </div>

        <div className="mb-5">
          <p className="form__label">About*</p>
          <textarea name="about" rows={5} value={formData.about} placeholder="Write about you" onChange={handleInputChange} className="form__input h-[150px]"></textarea>
        </div>
